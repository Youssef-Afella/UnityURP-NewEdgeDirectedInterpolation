...
public class SingleChannelUpscaleManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for(int i = 0; i < upscaledTextures.Length; i++)
        {
            ...
            upscaledTextures[i] = new RenderTexture(inputTexture.width * factor, inputTexture.height * factor, 0, RenderTextureFormat.RFloat, 0);
